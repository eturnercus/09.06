...
**Актуальный релиз:** [v1.3.8](https://github.com/eturnercus/09.06/releases/tag/v1.3.8) — все пять файлов в одном релизе.
...
> Для Firefox берите **v1.3.8** или новее — в более ранних версиях расширение было сломано.
